...
| --- | --- | --- | --- | --- | --- |
|Army-Knife|[Darkmoon](https://github.com/ASCIT31/Dark-Moon)|Autonomous AI penetration testing platform with agentic reasoning and real exploit execution across web, cloud, identity, CI/CD, Active Directory and Kubernetes|![](https://img.shields.io/github/stars/ASCIT31/Dark-Moon?label=%20)|[`pentest`](/categorize/tags/pentest.md) [`exploit`](/categorize/tags/exploit.md) [`recon`](/categorize/tags/recon.md) [`cloud`](/categorize/tags/cloud.md) [`report`](/categorize/tags/report.md)|![linux](/images/linux.png)![macos](/images/apple.png)![windows](/images/windows.png)[![Python](/images/python.png)](/categorize/langs/Python.md)|
